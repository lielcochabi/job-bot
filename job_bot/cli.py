...
from job_bot.paths import ENV_PATH
...
from job_bot import database, job_matcher, job_searcher, job_submitter, resume_parser
...
def search(
    ...
    from job_bot.job_matcher import SENIOR_TITLE_WORDS as _SENIOR_KW, JUNIOR_TITLE_WORDS as _JUNIOR_KW
